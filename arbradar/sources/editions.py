...
TERMS: Dict[str, List[str]] = {
    ...
    "ru": ['(арбитраж OR ICSID OR МЦУИС) (инвестор OR международный OR государство OR иск) -футбол -судья',
           ...
           '("приведение в исполнение" OR "признание и приведение в исполнение" OR "исполнение арбитражного решения" OR "отмена арбитражного решения" OR "арест активов" OR "иммунитет государства") (арбитраж OR арбитражного решения OR МЦУИС)'],
    "uk": ['(арбітраж OR ICSID) (інвестор OR міжнародний OR держава OR позов) -футбол',
           ...
           '("визнання та виконання" OR "виконання арбітражного рішення" OR "скасування арбітражного рішення" OR "арешт активів") (арбітраж OR арбітражного рішення)'],
    ...
    "tr": ['(tahkim OR ICSID) (yatırımcı OR uluslararası OR devlet OR dava) -maç -hakem',
           ...
           '("tenfiz" OR "tanıma ve tenfiz" OR "hakem kararının iptali" OR "haciz" OR "devlet bağışıklığı") (hakem kararı OR tahkim)'],
    "es": ['(arbitraje OR CIADI) (inversión OR inversionista OR inversor OR internacional OR Estado) -fútbol -árbitro -liga',
           ...
           '("ejecución del laudo" OR "homologación del laudo" OR "reconocimiento y ejecución" OR exequátur OR "inmunidad soberana" OR "embargo de activos") (laudo OR arbitral OR CIADI)'],
    "pt": ['(arbitragem OR CIRDI OR ICSID) (investimento OR investidor OR internacional OR Estado) -futebol -árbitro',
           ...
           '("execução da sentença arbitral" OR "homologação de sentença arbitral" OR "reconhecimento e execução" OR "imunidade soberana" OR "penhora de bens") (arbitral OR arbitragem OR CIRDI)'],
    "fr": ['(arbitrage OR CIRDI) (investissement OR investisseur OR international OR État) -football -match -arbitre',
           ...
           '("exequatur" OR "exécution de la sentence" OR "reconnaissance et exécution" OR "immunité d\'exécution" OR "saisie") (sentence arbitrale OR arbitrage OR CIRDI)'],
    "ar": ['("التحكيم الدولي" OR "المركز الدولي لتسوية منازعات الاستثمار") -مباراة -كرة',
           ...
           '("تنفيذ حكم التحكيم" OR "الاعتراف بحكم التحكيم" OR "إلغاء حكم التحكيم" OR "الحجز على أصول" OR "الحصانة السيادية") تحكيم'],
    ...
    "de": ['(Schiedsverfahren OR Schiedsgericht OR Schiedsspruch OR ICSID) (Investor OR international OR Staat OR Klage) -Schiedsrichter -Fußball',
           ...
           '("Vollstreckbarerklärung" OR "Vollstreckung des Schiedsspruchs" OR "Anerkennung und Vollstreckung" OR "Staatenimmunität" OR "Aufhebung des Schiedsspruchs") Schiedsspruch'],
    "it": ['(arbitrato OR ICSID OR "tribunale arbitrale") (investitore OR internazionale OR Stato OR causa) -arbitro -calcio',
           ...
           '("esecuzione del lodo" OR "riconoscimento del lodo" OR "delibazione" OR "immunità" OR "impugnazione del lodo") (lodo arbitrale OR arbitrato)'],
    ...
    "nl": ['(arbitrage OR ICSID OR scheidsgerecht) (investeerder OR internationaal OR staat OR claim) -scheidsrechter -voetbal',
           ...
           '("tenuitvoerlegging" OR "erkenning en tenuitvoerlegging" OR "exequatur" OR "vernietiging van het arbitraal vonnis" OR "beslag") (arbitraal vonnis OR arbitrage)'],
