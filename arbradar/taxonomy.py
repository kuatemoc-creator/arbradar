...
EVENT_PATTERNS: List = [
    ...
    ("enforcement_action", [
        "enforcement of the award", "enforcement of an award", "enforce the award", "enforce an award", "enforcing the award",
        "recognition and enforcement", "recognition of the award", "recognise the award", "recognize the award", "new york convention",
        "petition to confirm", "confirm the award", "confirmed the award", "confirmation of the award", "exequatur",
        "attachment of assets", "attach assets", "attached assets", "seize assets", "seized assets", "assets seized", "garnishment",
        "turnover order", "writ of execution", "charging order", "third-party debt order", "award creditor", "award creditors",
        "award debtor", "satisfy the award", "to satisfy an award", "sovereign immunity", "state immunity", "immunity from execution",
        "commercial exception", "embassy account", "central bank assets", "sovereign assets", "arrested the vessel to enforce",
        "registered the award", "registration of the award", "enforcement proceedings", "enforce the icsid award",
        # the same act in the languages of the sweeps
        "homologación del laudo", "reconocimiento y ejecución", "ejecución del laudo", "ejecución de laudo", "exequátur",
        "homologação de sentença arbitral", "reconhecimento e execução", "execução da sentença arbitral",
        "exequatur de la sentence", "exécution de la sentence arbitrale", "reconnaissance et exécution",
        "vollstreckbarerklärung", "vollstreckung des schiedsspruchs", "anerkennung und vollstreckung",
        "tenuitvoerlegging van het arbitraal vonnis", "erkenning en tenuitvoerlegging", "esecuzione del lodo", "riconoscimento del lodo",
        "признание и приведение в исполнение", "приведение в исполнение арбитражного решения", "исполнение арбитражного решения",
        "визнання та виконання", "виконання арбітражного рішення", "hakem kararının tenfizi", "tenfiz kararı", "tanıma ve tenfiz",
    ]),
    ("annulment_setaside", [
